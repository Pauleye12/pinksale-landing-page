...
class Introduction extends Component {
    render() { 
        return (
          <div className="marginTop testing">
            <div className="">
              ...
              <div className="center-btns">
                <button className="btn btn-create-now fw-bold rounded-4 me-3">
                  Create Now
                </button>
                <button className="btn btn-learn-more fw-bold rounded-4 ms-3">
                  Learn more
                </button>
              </div>
              ...
              <div className="growing-protocol">
                ...
                <p className="token-sales-text">
                  ...
                  finance. PinkMoon, PinkSale, PinkElon PinkLock, PinkSwap, we
                  Pink everything!
                </p>
